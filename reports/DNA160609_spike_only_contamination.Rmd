...
for (i in 1:length(align.files)){
  ...
  p14.contamination <- c(p14.contamination, length(curr.p14[,1]))
...
Currently, we identify spikes for removal using the first 9-bp sequence only. We could potentially use both the first and the second 9-bp sequences to remove spikes.